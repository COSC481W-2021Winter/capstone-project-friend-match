...
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (1, "testFirst", "testLast", "testCity", "testBio", "testInterest");
...
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (2, "Steve", "Jobs", "testCity", "Steve Jobs, of Apple", "testInterest");
INSERT INTO users (username, password) VALUES ("babyDriver", "' . password_hash("S3cur1tyIsMyP4ssi0n", PASSWORD_DEFAULT) . '");
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (3, "Baby", "Driver", "testCity", "Named after a movie", "testInterest");
INSERT INTO users (username, password) VALUES ("w3schools", "' . password_hash("IsAGodSend", PASSWORD_DEFAULT) . '");
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (4, "W3", "Schools", "specifically not the test city", "Help me", "testInterest");
INSERT INTO users (username, password) VALUES ("rjohn100", "' . password_hash("randolph", PASSWORD_DEFAULT) . '");
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (5, "Randolph", "Johnson", "testCity", "Just moved here, hoping to make some new friends", "testInterest");
...
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (7, "Josiah", "Jameson", "testCity", "Not interested in pictures of Spiderman", "Knitting");
...
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (14, "Jeffery", "Jefferson", "Detroit", "My name is Jeff.", "gaming,lifting,water-polo");
INSERT INTO users (username, password) VALUES("BepisMan", "' . password_hash("CokeSucks420", PASSWORD_DEFAULT) . '");
INSERT INTO profiles (userid, firstName, lastName, city, bio, interests) VALUES (15, "Cherry", "Pepsi", "Fresno", "I am a can of soda. I dont get out very often.", "drinking,chilling");
